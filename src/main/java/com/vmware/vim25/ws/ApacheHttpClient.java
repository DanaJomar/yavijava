...
//        Logger.debug("VMWareAPI", "Creating ApacheHttpClient to server URL: " + serverUrl);
//        Logger.debug("VMWareAPI", "Ignore ssl: " + ignoreCert);
     ...
     * <p>
     * Returns an {@link Object} of the given return type. Using the example above you would get a {@link
     * com.vmware.vim25.ServiceContent} Object.
     * <p>
     *
...
//            Logger.debug("VMWareAPI", "Converting xml response from server to: " + returnType);
            ...
            Logger.error("VMWareAPI", "Exception caught while invoking method. " + e1.getMessage());
    ...
    private InputStream post(String payload) throws IOException {
        ...
        if (trustAllSSL) {
            ...
            LayeredConnectionSocketFactory sslConnectionSocketFactory =
                    new SSLConnectionSocketFactory(CustomSSLTrustContextCreator.getTrustContext(trustManager),
...
//            Logger.debug("VMWareAPI", "Converted payload to String entity.");
        } catch (UnsupportedEncodingException e) {
            Logger.error(
                    "VMWareAPI",
                    "Failed to convert payload to StringEntity. Unsupported Encoding Exception caught. Payload: " +
        ...
        try {
            ...
            Logger.error("VMWareAPI", "Malformed URI sent: " + this.baseUrl.toString() + ". " + e.getMessage());
            return null;
        }
